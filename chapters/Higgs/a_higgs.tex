% \documentclass[.chapters/Higgs/.chapters/Higgs/main.tex]{subfiles}
...
In the next and final, mercifully brief chapter, I will summarize some of the principles of benchmarking we've learned/encountered along the way of this journey, in the hopes of providing a quicker referencefor the community.
...
\begin{figure}
\begin{center}
 	\includegraphics[width=.6\textwidth]{chapters/Higgs/Fig1-Hgg-Xgg.pdf}
	\end{center}
...
\begin{figure*}[hbt]
 \centering
  \includegraphics[width=.9\textwidth]{chapters/Higgs/Fig2-kinematical_variables.pdf}
%\vspace{-2.5cm}
...
\end{figure*}
 ...
 \begin{figure*}[hbt]
  \subfloat[]{\includegraphics[width=0.5\textwidth]{chapters/Higgs/Fig3a-ROC_example_100DWDNN}}
  \subfloat[]{\includegraphics[width=0.5\textwidth]{chapters/Higgs/Fig3b-ROC_example_100SAXGB}}\\
  \subfloat[]{\includegraphics[width=0.5\textwidth]{chapters/Higgs/Fig3c-ROC_example_20000DWDNN}}
  \subfloat[]{\includegraphics[width=0.5\textwidth]{chapters/Higgs/Fig3d-ROC_example_20000SAXGB}}
...
\begin{figure*}[hbt]
%\centering
\includegraphics[width=\textwidth]{chapters/Higgs/Fig4-aucs}
\caption{
...
\end{figure*}
 ...
 \begin{figure*}[hbt]
  \subfloat[]{\includegraphics[width=0.34\textwidth]{chapters/Higgs/Fig5a-full_DW--DNN_auc}}
  \subfloat[]{\includegraphics[width=0.34\textwidth]{chapters/Higgs/Fig5b-full_DW--XGB_auc}}
  \subfloat[]{\includegraphics[width=0.34\textwidth]{chapters/Higgs/Fig5c-full_DW--SA_auc}}
...
\begin{figure}
\centering
\subfloat[]{\includegraphics[width=0.49\textwidth]{chapters/Higgs/ROC_example_100DWDNN}}\\
\subfloat[]{\includegraphics[width=0.49\textwidth]{chapters/Higgs/ROC_example_100SAXGB}}
...
\section{Additional background and pedagogy}
 \label{sec:additional_background}
%\subsection{The quantum annealer approach to the Higgs optimization problem}
%
...
\subsection{Quantum annealing and D-Wave}
 \begin{figure}[hbt]
 \centering
...
Figure~\ref{fig:minimum_fractional_residual_energy} plots the fractional deviation of the minimum energy returned by the DW relative to the true ground state energy, averaged over the training sets. While the DW's minimum energy returned approaches the true ground state, it seems to converge to $\approx 5\%$ (i.e. $f\approx0.05$) above the ground state as we increase the chain strength,  for all training sizes $\geq 1000$. In this case, we were not able to find the optimal chain strength in a reasonable range of chain strengths, and instead simply took the best we found, $J_F=6$. As discussed in Sec.~\ref{app:ICE}, the DW processor suffers from noise sources on the couplers and thermal fluctuations, and it seems that this poses significant challenges for the performance of the quantum annealer. It is possible that even larger chain strengths may resolve the issue, but given the convergence visible in Fig.~\ref{fig:minimum_fractional_residual_energy}, it seems likely that $J_F=6$ is already near the optimum.
  ...
  \begin{figure}[hbb]
 \centering
  \includegraphics[width=0.7\columnwidth]{chapters/Higgs/rescaled_average_return_energy_by_J}
...
\begin{figure}
\centering
\subfloat[]{\includegraphics[width=.8\linewidth]{chapters/Higgs/noisy_couplers_h}}
\subfloat[]{\includegraphics[width=.8\linewidth]{chapters/Higgs/noisy_couplers_J}}
...
\begin{figure}[h]
\centering
\subfloat[]{\includegraphics[width=\textwidth]{chapters/Higgs/SAvc_shifted_vc_70--60_GS}}
\hfill
\vspace{-5cm}
\subfloat[]{\includegraphics[width=\textwidth]{chapters/Higgs/SAvc_shifted_vc_70--80_GS}}
\hfill
\vspace{-5cm}
\subfloat[]{\includegraphics[width=\textwidth]{chapters/Higgs/SAvc_shifted_vc_70--60_L5}}
\hfill
\vspace{-5cm}
\subfloat[]{\includegraphics[width=\textwidth]{chapters/Higgs/SAvc_shifted_vc_70--80_L5}}
\vspace{-4cm}
...
\centering
% \begin{adjustbox}{center}
\includegraphics[width=0.6\paperwidth]{chapters/Higgs/DW--SA_L5}
% \end{adjustbox}
...
\centering
% \begin{adjustbox}{center}
\includegraphics[width=0.6\paperwidth]{chapters/Higgs/DW--DNN_GS}
% \end{adjustbox}
...
\centering
% \begin{adjustbox}{center}
\includegraphics[width=0.6\paperwidth]{chapters/Higgs/DW--XGB_GS}
% \end{adjustbox}
...
\centering
% \begin{adjustbox}{center}
\includegraphics[width=0.6\paperwidth]{chapters/Higgs/SA--SA_L5}
% \end{adjustbox}
...
\centering
% \begin{adjustbox}{center}
\includegraphics[width=0.6\paperwidth]{chapters/Higgs/DW--DW_L5}
% \end{adjustbox}
